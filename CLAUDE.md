...
| --- | --- | --- |
| **Symlinked** | Live — change is immediate | nvim, lazygit, zed, ghostty `themes/`, claude skills, `gitignore_global`, jj `config.toml`, all `mac/*` configs (hammerspoon, vscode, sketchybar, yabai, phpstorm), arch `hypr/waybar/rofi/mako`, keyd |
